...
Use the tab JavaScript plugin—include it individually or through the compiled `app-bootstrap.js` file—to extend our list group to create tabbable panes of local content.
